...
class MYNT_PICTURE{
	...
	public static $default_page_dir = "data/page/";
	...
	public static function getEyecatchFilePath($articleId = ""){
		...
		$page_info_path = self::$default_page_dir.$pageDir."/".$articleId.".info";
		if(!is_file($page_info_path)){return;}

		$jsonPage = json_decode(file_get_contents(self::$default_page_dir.$pageDir."/".$articleId.".info") , true);
